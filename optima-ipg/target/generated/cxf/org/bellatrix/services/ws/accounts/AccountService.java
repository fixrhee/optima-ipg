 ...
 * 2020-04-13T08:54:18.526+07:00
 * Generated source version: 2.7.15
 * 
 */
@WebServiceClient(name = "AccountService", 
                  wsdlLocation = "http://149.129.215.223:8081/bellatrix/host/services/ws/accounts?wsdl",
...
public class AccountService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://149.129.215.223:8081/bellatrix/host/services/ws/accounts?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccountService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://149.129.215.223:8081/bellatrix/host/services/ws/accounts?wsdl");
        }
        WSDL_LOCATION = url;
    }
